...
public class QcomCameraProxy extends CameraHardwareProxy {
    public Camera openCamera(int cameraId) {
        Camera camera = null;
        try {
            Object c = ReflectUtil.callMethod(Class.forName("android.hardware.Camera"), null, "openLegacy", "(II)Landroid/hardware/Camera;", Integer.valueOf(cameraId), Integer.valueOf(256));
            Log.e("QcomCameraProxy", "openLegacy is " + c);
            camera = c == null ? null : (Camera) c;
        } catch (Exception e) {
    ...
    public void setLongshotMode(Camera camera, boolean enable) {
        ReflectUtil.callMethod(camera.getClass(), camera, "setLongshot", "(Z)V", Boolean.valueOf(enable));
    }
    ...
    public boolean isFocusSuccessful(Camera camera) {
        ...
        if (successFlag != 0) {
            Object value = ReflectUtil.callMethod(camera.getClass(), camera, "getFocusState", "()I", new Object[0]);
            if (value != null) {
                if (successFlag != ((Integer) value).intValue()) {
                    z = false;
                }
                return z;
            }
    ...
    public void startObjectTrack(Camera camera, int left, int top, int width, int height) {
        ...
        ReflectUtil.callMethod(camera.getClass(), camera, "startTrack", "(IIII)V", Integer.valueOf(left), Integer.valueOf(top), Integer.valueOf(width), Integer.valueOf(height));
    }

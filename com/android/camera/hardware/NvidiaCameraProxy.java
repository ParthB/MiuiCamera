...
public class NvidiaCameraProxy extends CameraHardwareProxy {
    public Camera openCamera(int cameraId) {
        try {
            Class<?>[] ownerClazz = new Class[]{Class.forName("com.nvidia.NvCamera")};
            Method method = Util.getMethod(ownerClazz, "open", "(I)Lcom/nvidia/NvCamera;");
            if (method != null) {
                return (Camera) method.invokeObject(ownerClazz[0], null, new Object[]{Integer.valueOf(cameraId)});
            }
            Log.e("NvidiaCameraProxy", "openCamera fail NoSuchMethodException ownerClazz=" + ownerClazz[0]);
            return null;
    ...
    public void setParameters(Camera camera, Parameters params) {
        try {
            ...
            Method method = Util.getMethod(ownerClazz, "native_setCustomParameters", "(Ljava/lang/String;)V");
            if (method != null) {
                method.invokeObject(ownerClazz[0], camera, new Object[]{params.flatten()});
            } else {
                Log.e("NvidiaCameraProxy", "setParameters NoSuchMethodException ownerClazz=" + ownerClazz[0]);
            }
    ...
    public void cancelContinuousMode(Camera camera) {
        try {
            Class<?>[] ownerClazz = new Class[]{camera.getClass()};
            Util.getMethod(ownerClazz, "cancelPicture", "()V").invoke(ownerClazz[0], camera, new Object[0]);
    ...
    public int getWBCurrentCCT(Camera camera) {
        try {
            Class<?>[] ownerClazz = new Class[]{camera.getClass()};
            Method method = Util.getMethod(ownerClazz, "getWbCCT", "()I");
            if (method != null) {
                return method.invokeInt(ownerClazz[0], camera, new Object[0]);
            }
        } catch (IllegalArgumentException e) {

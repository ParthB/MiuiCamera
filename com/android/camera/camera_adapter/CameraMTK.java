...
public class CameraMTK extends CameraModule {
    ...
    private class SaveHandler extends Handler {
        ...
        private void saveFile(byte[] mXmpJpegData, String title) {
            ...
            CameraMTK.this.mActivity.getImageSaver().addImage(6, mXmpJpegData, title, System.currentTimeMillis(), null, CameraMTK.this.mJpegPictureCB.getLocation(), width, height, null, orientation, false, false, true);
        }
    }
    ...
    private Object constructObject() {
        ...
        try {
            ...
            Log.e("Camera", "NoSuchMethod", e);
            return null;
        } catch (ClassNotFoundException e2) {
            Log.e("Camera", "no class com.mediatek.xmp.XmpOperator", e2);
            return null;
        }
    }
    ...
    private byte[] writeStereoCaptureInfoToJpg(String pictureName, byte[] originalJpegData, byte[] jpsData, byte[] maskAndConfigDat, byte[] clearImage, byte[] depthMap, byte[] ldcData) {
        try {
            ...
            return (byte[]) Method.of(cls, "writeStereoCaptureInfoToJpg", "(Ljava/lang/String;[B[B[B[B[B[B)[B").invokeObject(cls, this.mOperator, new Object[]{pictureName, originalJpegData, jpsData, maskAndConfigDat, clearImage, depthMap, ldcData});
        } catch (ClassNotFoundException e) {
            Log.e("Camera", "no class com.mediatek.xmp.XmpOperator", e);
            return null;
        } catch (NoSuchMethodException e2) {
            Log.e("Camera", "no method writeStereoCaptureInfoToJpg", e2);
            return null;
        }
    }
    ...
    private void setJsonBuffer(byte[] maskAndConfigData) {
        try {
            Class<?> cls = Class.forName("com.mediatek.xmp.XmpOperator");
            Method.of(cls, "setJsonBuffer", "([B)V").invoke(cls, this.mOperator, new Object[]{maskAndConfigData});
        } catch (ClassNotFoundException e) {
            Log.e("Camera", "no class com.mediatek.xmp.XmpOperator", e);
        } catch (NoSuchMethodException e2) {
            Log.e("Camera", "no method setJsonBuffer", e2);
        }
    }

...
public class ImageSaver extends Thread {
    ...
    public void addImage(int saveType, byte[] data, String title, long date, Uri uri, Location loc, int width, int height, ExifInterface exif, int orientation, boolean isHide, boolean isMapFile, boolean finalImage) {
        addImage(saveType, data, title, null, date, uri, loc, width, height, exif, orientation, isHide, isMapFile, finalImage);
    }

    public void addImage(int saveType, byte[] data, String title, String oldTitle, long date, Uri uri, Location loc, int width, int height, ExifInterface exif, int orientation, boolean isHide, boolean isMapFile, boolean finalImage) {
    ...
    public void run() {
        ...
        r20 = this;
        r0 = r20;
        r3 = r0.mMemoryManager;
        r3.initMemory();
    L_0x0007:
        monitor-enter(r20);
        r0 = r20;
        r3 = r0.mQueue;	 Catch:{ all -> 0x00bc }
        r3 = r3.isEmpty();	 Catch:{ all -> 0x00bc }
        if (r3 == 0) goto L_0x002a;
    L_0x0012:
        r0 = r20;
        r3 = r0.mStop;	 Catch:{ all -> 0x00bc }
        if (r3 == 0) goto L_0x0023;
    L_0x0018:
        r3 = "ImageSaver";
        r4 = "run: exiting";
        com.android.camera.Log.d(r3, r4);	 Catch:{ all -> 0x00bc }
        monitor-exit(r20);
        return;
    L_0x0023:
    ...
    L_0x002a:
        ...
        r3 = r0.mQueue;	 Catch:{ all -> 0x00bc }
        r4 = 0;
        r19 = r3.get(r4);	 Catch:{ all -> 0x00bc }
        r19 = (com.android.camera.storage.ImageSaver.SaveRequest) r19;	 Catch:{ all -> 0x00bc }
        monitor-exit(r20);
        r0 = r19;
        r3 = r0.oldTitle;
    ...
    L_0x004a:
        ...
        r18 = r0;
        r3 = r20;
        r3.storeImage(r4, r5, r6, r7, r8, r10, r11, r12, r13, r14, r15, r16, r17, r18);
        monitor-enter(r20);
        r0 = r19;
        r3 = r0.data;	 Catch:{ all -> 0x00b9 }
        if (r3 == 0) goto L_0x00a0;
    L_0x0094:
        r0 = r20;
        r3 = r0.mMemoryManager;	 Catch:{ all -> 0x00b9 }
        r0 = r19;
        r4 = r0.data;	 Catch:{ all -> 0x00b9 }
        r4 = r4.length;	 Catch:{ all -> 0x00b9 }
        r3.reduceUsedMemory(r4);	 Catch:{ all -> 0x00b9 }
    L_0x00a0:
        r0 = r20;
        r3 = r0.mQueue;	 Catch:{ all -> 0x00b9 }
        r4 = 0;
        r3.remove(r4);	 Catch:{ all -> 0x00b9 }
        r0 = r20;
        r3 = r0.mMemoryManager;	 Catch:{ all -> 0x00b9 }
        r3 = r3.isSaveQueueFull();	 Catch:{ all -> 0x00b9 }
        if (r3 != 0) goto L_0x0026;
    L_0x00b2:
        r3 = 0;
        r0 = r20;
        r0.mShouldStop = r3;	 Catch:{ all -> 0x00b9 }
        goto L_0x0026;
    L_0x00b9:
        r3 = move-exception;
        monitor-exit(r20);
    ...
    private void storeImage(int saveType, byte[] data, Uri uri, String title, long date, Location loc, int width, int height, ExifInterface exif, int orientation, boolean isHide, boolean isMap, boolean finalImage, String oldTitle) {
        if (uri != null) {
            Storage.updateImage(this.mActivity, data, exif, uri, title, loc, orientation, width, height, oldTitle);
        } else if (data != null) {
            uri = Storage.addImage(this.mActivity, title, date, loc, orientation, data, width, height, false, isHide, isMap);
        }
        Storage.getAvailableSpace();
        if (uri != null) {
            boolean needThumbnail;
            synchronized (this) {
                needThumbnail = (this.mHostState == 0 && isLastImageForThumbnail() && !this.mIsImageCaptureIntent && finalImage) ? saveType != 4 : false;
            }
            if (needThumbnail) {
                Thumbnail t;
                ...
                t.setUpdateAnimation(saveType != 12);
                synchronized (this.mUpdateThumbnailLock) {

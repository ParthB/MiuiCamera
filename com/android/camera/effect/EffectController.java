...
public class EffectController {
    ...
    private ArrayList<String> mEffectEntryNames;
    ...
    public String[] getEntryNames() {
        String[] result = new String[this.mEffectEntryNames.size()];
        this.mEffectEntryNames.toArray(result);
        return result;
    }
    ...
    private String getResourceEntryName(int strId) {
        return CameraAppImpl.getAndroidContext().getResources().getResourceEntryName(strId);
    }
    ...
    private void addEntryItem(int strId, int id) {
        ...
        this.mEffectEntryNames.add(getResourceEntryName(strId));
    }
    ...
    public RenderGroup getEffectGroup(GLCanvas canvas, RenderGroup renderGroup, boolean wholeRender, boolean isSnapShotRender, int index) {
        ...
        if (canvas == null) {
            ...
            this.mEffectEntryNames = new ArrayList();

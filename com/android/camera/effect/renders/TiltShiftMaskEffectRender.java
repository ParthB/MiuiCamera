...
public class TiltShiftMaskEffectRender extends RegionEffectRender {
    ...
    public TiltShiftMaskEffectRender(GLCanvas canvas, int id) {
        super(canvas, id);
    }
    ...
    protected void initShaderValue(boolean isSnapShot) {
        ...
        GLES20.glUniform1f(this.mUniformMaskAlphaH, isSnapShot ? 0.0f : EffectController.getInstance().getTiltShiftMaskAlpha());
    }

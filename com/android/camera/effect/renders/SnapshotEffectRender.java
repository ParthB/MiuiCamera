...
public class SnapshotEffectRender {
    ...
    private class EGLHandler extends Handler {
        ...
        private boolean drawMainJpeg(DrawJPEGAttribute jpeg, boolean save) {
            ...
            if (save) {
                ...
                if (SnapshotEffectRender.this.mImageSaver != null) {
                    ...
                    -get9.addImage(bArr, str, title == null ? null : jpeg.mTitle, jpeg.mDate, jpeg.mUri, jpeg.mLoc, jpeg.mWidth, jpeg.mHeight, jpeg.mExif, jpeg.mJpegOrientation, false, false, title == null ? jpeg.mFinalImage : false, jpeg.mPortrait);
                } else {
                    Uri jpegUri;
                    Context -get0;
                    if (jpeg.mUri == null) {
                        String str2;
                        -get0 = SnapshotEffectRender.this.mActivity;
                        if (title == null) {
                            str2 = jpeg.mTitle;
                        } else {
                            str2 = title;
                        }
                        jpegUri = Storage.addImage(-get0, str2, jpeg.mDate, jpeg.mLoc, jpeg.mJpegOrientation, jpeg.mData, jpeg.mWidth, jpeg.mHeight, false, false, false, jpeg.mPortrait);
                    } else {
                        String str3;
                        jpegUri = jpeg.mUri;
                        -get0 = SnapshotEffectRender.this.mActivity;
                        ...
                        Storage.updateImage(-get0, bArr, exifInterface, uri, str3, jpeg.mLoc, jpeg.mJpegOrientation, jpeg.mWidth, jpeg.mHeight, title == null ? null : jpeg.mTitle, jpeg.mPortrait);
                    }
                    if (jpeg.mPortrait) {
                        PhotosSpecialTypesProvider.markPortraitSpecialType(SnapshotEffectRender.this.mActivity, jpegUri);
                    }
                    ProcessingMediaManager.instance().removeProcessingMedia(SnapshotEffectRender.this.mActivity, jpeg.mUri);
                }
        ...
        private boolean drawThumbJpeg(DrawJPEGAttribute jpeg, boolean save) {
            ...
            if (save && jpeg.mExif.getThumbnailBytes() != null) {
                jpeg.mUri = Storage.addImage(SnapshotEffectRender.this.mActivity, jpeg.mTitle, jpeg.mDate, jpeg.mLoc, jpeg.mJpegOrientation, jpeg.mExif.getThumbnailBytes(), size.width, size.height, false, false, false, appendExif, true);
                if (jpeg.mUri != null) {
                    SnapshotEffectRender.this.mActivity.addSecureUri(jpeg.mUri);
                    ProcessingMediaManager.instance().addProcessingMedia(SnapshotEffectRender.this.mActivity, jpeg.mUri, new JpegThumbnail(jpeg.mJpegOrientation, jpeg.mExif.getThumbnailBytes()));
                }
            }
            return true;
        }
    ...
    public SnapshotEffectRender(ActivityBase activity, boolean isImageCaptureIntent) {
        ...
        if (CameraSettings.isSupportedOpticalZoom()) {
            ...
            this.mDualCameraWaterMark = BitmapFactory.decodeResource(this.mActivity.getResources(), R.raw.dualcamera_watermark, options);
        }
    }
    ...
    public boolean processorJpegAsync(DrawJPEGAttribute jpeg) {
        ...
        if (!this.mIsImageCaptureIntent && sync && this.mExifNeeded) {
            ...
            if (!(bitmap == null || jpeg.mUri == null)) {
                ...
                this.mActivity.getThumbnailUpdater().setThumbnail(Thumbnail.createThumbnail(jpeg.mUri, bitmap, jpeg.mJpegOrientation, false));
            }
        }

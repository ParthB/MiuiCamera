...
public class DrawJPEGAttribute extends DrawAttribute {
    ...
    public DrawJPEGAttribute(byte[] data, int previewW, int previewH, int w, int h, int effectIndex, EffectRectAttribute attribute, Location loc, String title, long date, int orientation, int jpegOrientation, float shootRotation, boolean mirror) {

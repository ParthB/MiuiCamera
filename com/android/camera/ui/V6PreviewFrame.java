...
public class V6PreviewFrame extends RelativeLayout implements OnLayoutChangeListener, V6FunctionUI {
    ...
    public boolean isFullScreen() {
        if (Math.abs(this.mAspectRatio - CameraSettings.getPreviewAspectRatio(Util.sWindowHeight, Util.sWindowWidth)) < 0.1f || Math.abs(((double) this.mAspectRatio) - 1.5d) < 0.10000000149011612d) {
            return true;
        }
        return false;
    }

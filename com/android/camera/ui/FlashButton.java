...
public class FlashButton extends AnimationImageView implements MessageDispacher, OnClickListener {
    ...
    public void initializeXml(boolean isVideo) {
        ...
        if (!CameraSettingPreferences.instance().isFrontCamera() || (Device.isSupportFrontFlash() && (!this.mIsVideo || Device.isSupportVideoFrontFlash()))) {
            this.mVisible = true;
            setVisibility(0);
            if (!avoidTorchOpen()) {
                refreshValue();
    ...
    public void onCameraOpen() {
        ...
        if (!isFront || (Device.isSupportFrontFlash() && (!this.mIsVideo || Device.isSupportVideoFrontFlash()))) {
            List list;
    ...
    public boolean couldBeVisible() {
        return !CameraSettingPreferences.instance().isBackCamera() ? Device.isSupportFrontFlash() : true;
    }

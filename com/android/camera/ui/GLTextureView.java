            ...
            if (this.mEgl.eglInitialize(this.mEglDisplay, new int[2])) {
                ...
                if (view == null) {
                    ...
                    if (view.mShareContextGetter == null) {
                        ...
                        eGLContext = view.mShareContextGetter.getShareContext();
                    }
                    this.mEglContext = view.mEGLContextFactory.createContext(this.mEgl, this.mEglDisplay, this.mEglConfig, eGLContext);
                }

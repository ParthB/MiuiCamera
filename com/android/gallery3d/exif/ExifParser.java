...
class ExifParser {
        ...
        if (offset == endOfTags) {
            ...
            if (this.mIfdType == 0) {
                ...
                if (offsetSize < 4) {
                    ...
                    ifdOffset = readUnsignedLong();
                    if (ifdOffset != 0) {
                        Log.w("ExifParser", "Invalid link to next IFD: " + ifdOffset);
                    }
                }
            }
        }
    ...
    private ExifTag readTag() throws IOException, ExifInvalidFormatException {
        ...
        if (numOfComp > 2147483647L) {
            ...
            Log.w("ExifParser", String.format(Locale.ENGLISH, "Tag %04x: Invalid data type %d", new Object[]{Short.valueOf(tagId), Short.valueOf(dataFormat)}));

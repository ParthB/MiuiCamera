...
public class StringTexture extends CanvasTexture {
    ...
    public /* bridge */ /* synthetic */ boolean isPremultiplied() {
        return super.isPremultiplied();
    }
    ...
    private static void setLongshotMode(TextPaint paint, float letterSpacing) {
        if (VERSION.SDK_INT >= 21) {
            try {
                Method.of(TextPaint.class, "setLetterSpacing", "(F)V").invoke(TextPaint.class, paint, new Object[]{Float.valueOf(letterSpacing)});
            } catch (NoSuchMethodException e) {
            } catch (IllegalArgumentException e2) {
                Log.e("StringTexture", "setLongshotMode IllegalArgumentException");
            }
        }
    }

...
final class DetectionResultRowIndicatorColumn extends DetectionResultColumn {
    ...
    int adjustCompleteIndicatorColumnRowNumbers(BarcodeMetadata barcodeMetadata) {
        ...
        ResultPoint top = !this.isLeft ? boundingBox.getTopRight() : boundingBox.getTopLeft();
        ResultPoint bottom = !this.isLeft ? boundingBox.getBottomRight() : boundingBox.getBottomLeft();
            ...
            if (codewords[codewordsRow] != null) {
                ...
                if (rowDifference == 0) {
                    ...
                    if (checkedRows < codewordsRow) {
                        closePreviousCodewordFound = false;
                    } else {
                        closePreviousCodewordFound = true;
                    }
                    for (int i = 1; i <= checkedRows && !closePreviousCodewordFound; i++) {
                        if (codewords[codewordsRow - i] == null) {
                            closePreviousCodewordFound = false;
                        } else {
                            closePreviousCodewordFound = true;
                        }

...
final class BitMatrixParser {
    ...
    private int copyBit(int i, int j, int versionBits) {
        return !(!this.mirror ? this.bitMatrix.get(i, j) : this.bitMatrix.get(j, i)) ? versionBits << 1 : (versionBits << 1) | 1;
    }
    ...
    byte[] readCodewords() throws FormatException {
        ...
        while (j > 0) {
            ...
            while (count < dimension) {
                int i = !readingUp ? count : (dimension - 1) - count;
                int col = 0;
                ...
                while (col < 2) {
                    if (functionPattern.get(j - col, i)) {
                        ...
                        if (bitsRead != 8) {
                            ...
                            result[resultOffset2] = (byte) ((byte) currentByte);
                            bitsRead = 0;
                            currentByte = 0;
                        }
                    }

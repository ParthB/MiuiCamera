    ...
    byte[] readCodewords() throws FormatException {
        ...
        while (true) {
            ...
            if (row == numRows && column == 0 && !corner1Read) {
                ...
                result[resultOffset] = (byte) ((byte) readCorner1(numRows, numColumns));
                row -= 2;
                column += 2;
                corner1Read = true;
            } else if (row == numRows - 2 && column == 0 && (numColumns & 3) != 0 && !corner2Read) {
                resultOffset2 = resultOffset + 1;
                result[resultOffset] = (byte) ((byte) readCorner2(numRows, numColumns));
                row -= 2;
                column += 2;
                corner2Read = true;
            } else if (row == numRows + 4 && column == 2 && (numColumns & 7) == 0 && !corner3Read) {
                resultOffset2 = resultOffset + 1;
                result[resultOffset] = (byte) ((byte) readCorner3(numRows, numColumns));
                row -= 2;
                column += 2;
                corner3Read = true;
            } else if (row == numRows - 2 && column == 0 && (numColumns & 7) == 4 && !corner4Read) {
                resultOffset2 = resultOffset + 1;
                result[resultOffset] = (byte) ((byte) readCorner4(numRows, numColumns));
                row -= 2;
                column += 2;
                corner4Read = true;
            } else {
                while (true) {
                    if (row < numRows && column >= 0 && !this.readMappingMatrix.get(column, row)) {
                        resultOffset2 = resultOffset + 1;
                        result[resultOffset] = (byte) ((byte) readUtah(row, column, numRows, numColumns));
                    } else {
